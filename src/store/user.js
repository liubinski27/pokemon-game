...
export const getUserUpdateAsync = () => async  (dispatch) => {
    ...
    if (idToken) {
        ...
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyCn00yeXZaR9eC_scgYIO_lotxUcqlqZ04', requestOptions).then(res => res.json());
